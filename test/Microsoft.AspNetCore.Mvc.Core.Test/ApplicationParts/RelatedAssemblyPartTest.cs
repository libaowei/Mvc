...
namespace Microsoft.AspNetCore.Mvc.ApplicationParts
{
    public class RelatedAssemblyPartTest
    {
        ...
        public void GetRelatedAssemblies_Noops_ForDynamicAssemblies()
        {
            ...
            // Act
            var result = RelatedAssemblyAttribute.GetRelatedAssemblies(assembly);
        ...
        public void GetRelatedAssemblies_ThrowsIfRelatedAttributeReferencesSelf()
        {
            ...
            // Act & Assert
            var ex = Assert.Throws<InvalidOperationException>(() => RelatedAssemblyAttribute.GetRelatedAssemblies(assembly));
        ...
        public void GetRelatedAssemblies_ThrowsIfAssemblyCannotBeFound()
        {
            ...
            // Act & Assert
            var ex = Assert.Throws<FileNotFoundException>(() => RelatedAssemblyAttribute.GetRelatedAssemblies(assembly));
            Assert.Equal(expected, ex.Message);
        ...
        public void GetRelatedAssemblies_LoadsRelatedAssembly()
        {
            ...
            try
            {
                ...
                var result = RelatedAssemblyAttribute.GetRelatedAssemblies(assembly, file =>
                {
        ...
        private class TestAssembly : Assembly
        {
            ...
            public override string Location => Path.Combine(AssemblyDirectory, "MyAssembly.dll");
