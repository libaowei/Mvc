...
namespace Microsoft.AspNetCore.Mvc.ApplicationParts
{
    ...
    public sealed class RelatedAssemblyAttribute : Attribute
    {
        ...
        public static IReadOnlyList<Assembly> GetRelatedAssemblies(Assembly assembly)
        {
            if (assembly == null)
            {
            ...
            return GetRelatedAssemblies(assembly, Assembly.LoadFile);
        }

        internal static IReadOnlyList<Assembly> GetRelatedAssemblies(Assembly assembly, Func<string, Assembly> loadFile)
        {
            if (assembly == null)
            {
                throw new ArgumentNullException(nameof(assembly));
            ...
            var relatedAssemblies = new Assembly[attributes.Length];
            for (var i = 0; i < attributes.Length; i++)
            {
                ...
                relatedAssemblies[i] = loadFile(relatedAssemblyLocation);
            }
